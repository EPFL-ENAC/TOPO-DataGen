...
if __name__ == "__main__":
    ...
    point_cloud_colorization('/media/regislongchamp/Windows/projects/TOPO-DataGen/data_preprocess/demo/demo-surface3d/classified_point_cloud_0_0.las',
    path_out_file_point_cloud ='/media/regislongchamp/Windows/projects/TOPO-DataGen/data_preprocess/demo/demo-surface3d/classified_point_cloud_0_0_c.las',
    path_in_file_orthophoto = '/media/regislongchamp/Windows/projects/TOPO-DataGen/data_preprocess/demo/demo-swissimage10/mergedTIF_3857.tif'
    )
