...
def prepare_lhs(num_dp: int, lon_range: list, lat_range: list, h_range: list,
                ...
                data_name: str, data_type: str = "geocentric") -> None:
    """
    ...
    preset = SCRIPT_DIR + '/presets/' + data_name
    if not os.path.exists(preset):
        os.makedirs(preset)
    np.save(preset + '/' + data_name + '_poses.npy', lhd)
...
def start_server(dataset_name: str, scene_name: str,
