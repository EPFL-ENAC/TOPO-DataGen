...
def run_data_preprocessing(dataset = 'demo') :
    ...
    path_out_file_merged_orthophoto = os.path.join(data_folder_path, f'{dataset}-{settings.ORTHOPHOTO.OUTPUT_FOLDER_NAME}',
    ...
    path_out_file_orthophoto_reprojected = os.path.join(data_folder_path, f'{dataset}-{settings.ORTHOPHOTO.OUTPUT_FOLDER_NAME}',
                                                   f"{settings.ORTHOPHOTO.OUTPUT_FILE_NAME}_wgs84.tif")
    # orthophoto_reprojection(path_in_file_orthophoto_to_reproject,path_out_file_orthophoto_reprojected,epsg_in,epsg_out)
    ...
    path_out_folder_point_cloud = os.path.join(data_folder_path, f'{dataset}-{settings.POINTS_CLOUD.OUTPUT_FOLDER_NAME}')
    ...
    # point_cloud_batch_colorization(path_in_folder_point_cloud,path_out_folder_point_cloud_color,path_out_file_merged_orthophoto,'',logger)
    ...
    # point_cloud_batch_reprojection(path_in_folder_point_cloud_to_reproject, path_out_folder_point_cloud_reprojected, 3857, 4978,'',logger)
    ...
    # point_cloud_batch_downsampling(path_in_folder_point_cloud_to_downsample,path_out_folder_point_cloud_downsampled,'',logger)
    ...
    # create_cesium_3d_tiles(path_in_folder_point_cloud_cesium_tiles,path_out_folder_point_cloud_ept,path_out_folder_point_cloud_cesium_tiles)
    ...
    # path_in_file_digital_surface_model_to_reproject = digital_surface_model_merging(path_in_folder_digital_surface_model,path_out_file_digital_surface_model,logger)
    ...
    # digital_surface_model_reprojection(path_in_file_digital_surface_model_to_reproject,path_out_file_digital_surface_model_reprojected,'3857','4979')
    ...
    # create_cesium_terrain_file(path_in_file_merged_orthophoto,path_out_folder_cesium_terrain_tile)
